    ...
    <div className="footer">
      ...
      <div className="footer--wrapper">
        <div className="footer--links">
          ...
          <Link href="/Plans" className="footer--link">Plans</Link>
        ...
        <div className="footer--links">
          ...
          <Link href="/" target='_blank' rel="noopener noreferrer" className="footer--link">Facebook</Link>
          <Link href="/" target='_blank' rel="noopener noreferrer" className="footer--link">Twitter</Link>
          <Link href="/" target='_blank' rel="noopener noreferrer" className="footer--link">Instagram</Link>
          <Link href="/" target='_blank' rel="noopener noreferrer" className="footer--link">Youtube</Link>
